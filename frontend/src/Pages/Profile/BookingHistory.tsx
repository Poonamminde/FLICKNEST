...
const BookingHistory = () => {
  return (
    <>
    <div className='px-4 md:px-8 rounded-md'>
                    ...
                    <div className="flex items-start gap-2 md:gap-10">
                        ...
                        <div className='flex items-start justify-between w-full'>
                            <div className='flex-1'>
                                <p className='font-normal text-normal md:text-lg'>
                                    {order.title}
                                </p>
                            ...
                            <p className='hidden md:block'>M-Ticket</p>
                        </div>
                    </div>
                    <div className="p-4 text-right">
                        <p className='text-xs md:text-sm text-gray-500'>Ticket: ₹ {order.ticket.toFixed(2)} + Convenience Fees: ₹ {order.fee.toFixed(2)}</p>
